...
export function ProductClientView({ product, storeSlug }: ProductClientViewProps) {
  ...
  const handleAddToCart = () => {
    if (quantity > 0 && quantity <= maxAvailable) {
      ...
      // Reset local counter if needed or logic
      setQuantity(1)
    }
  }
        ...
        {maxAvailable > 0 ? (
          <div className="space-y-4">
            ...
            <button 
              ...
              className="w-full bg-slate-900 text-white font-bold py-4 rounded-xl hover:bg-slate-800 active:scale-[0.98] transition-all flex justify-center items-center space-x-2"
            >
